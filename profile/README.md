...
# What's Monkestation?
Monkestation runs a family of [Space Station 13](https://www.youtube.com/watch?v=nLAHBexJxrE) servers (US based), with our primary server being Medium-Rare. You can learn more about the game on the [main website](https://monkestation.com/).

Monkestation is a family of 4 SS13 servers, listed below:
...
- [OculisStation](https://github.com/Monkestation/OculisStation) - Based on [IrisStation](https://github.com/IrisSS13/IrisStation) code, Oculis aims to be a spiritual successor to Iris, since Iris will be shutting down at the end of February 2026. It is not meant to be Iris two, but a home for Iris players so the community has somewhere to go.
...
- [Crimson Grid](https://github.com/Monkestation/crimson-grid/) - A fork of [SecondCity](https://github.com/DarkPack13/SecondCity), a World of Darkness setting city simulator. Should the Masquerade fall, Obama's drone strike force stands ready.

Monkestation also hosts other servers on the box that are not listed here! Box space is not given freely.
